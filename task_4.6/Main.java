...
Годы 2100, 2200 и 2300 - не високосные.
    ...
    static void Wisokos(int god) {
        int x = 366;
        System.out.println("Год "+god+" високосный");
        System.out.println("Количество дней в году "+god+":"+x);
    }
    static void NWisokos(int god) {
        int x = 365;
        System.out.println("Год "+god+" не високосный");
        System.out.println("Количество дней в году "+god+":"+x);
    }
}
